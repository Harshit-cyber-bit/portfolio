...
async function updateCounter() {
  let response = await fetch("https://cesklkfqycqjd3nfch457pa3vy0isxvv.lambda-url.ap-south-1.on.aws/");
...
//   const roles = ["Batman.", "Penetration Tester.", "AWS Security Enthusiast.", "CTF Player.", "Freelancer.", "Blogger."];
//   let roleIndex = 0;
...
//   // Update role every 1200 milliseconds
//   setInterval(updateRole, 1200);
// });
